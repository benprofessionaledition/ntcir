...
from ntcir.algorithm.masked_conv import masked_conv1d_and_max
...
def model_fn(features, labels, mode, params):
    ...
    with tf.name_scope("char_conv"):
        ...
        char_embedding_conv = masked_conv1d_and_max(
    ...
    with tf.name_scope("word_char_embedding_concat"):
        ...
        embeddings = tf.concat([word_embeddings, char_embedding_conv], axis=-1)
